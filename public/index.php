...
if ($action) {
    $allowed_actions = ['auth_booking', 'payment_gateway', 'submit_review', 'admin_login', 'admin_logout', 'admin_manage_layanan', 'admin_pay_transaction', 'admin_update_status', 'get_queue_status'];
