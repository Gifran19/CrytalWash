    ...
    <footer class="bg-gradient-to-b from-gray-50 dark:from-slate-900 to-gray-100 dark:to-slate-800 border-t border-gray-200 dark:border-gray-800 mt-auto transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="flex flex-col items-center gap-6 md:flex-row md:justify-between md:items-center md:gap-0">
                ...
                <div class="flex flex-col items-center gap-2 md:flex-row md:gap-0 w-full md:w-auto md:order-1">
                    <p class="text-xs text-gray-400 dark:text-gray-500 text-center md:text-left">
                        &copy; 2026 CrystalWash. <?= trans('footer_copyright') ?>
                    </p>
                    <p class="text-xs text-gray-400 dark:text-gray-500 text-center md:text-left md:ml-8">
