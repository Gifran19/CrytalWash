        ...
        <div class="flex flex-col md:flex-row justify-between items-center py-4">
            ...
            <div class="w-full md:w-1/2 max-w-lg">
                <div class="relative flex justify-between items-center w-full">
                    ...
                    <div class="absolute left-0 top-1/2 -translate-y-1/2 h-1 bg-olive-700 rounded-full z-0 transition-all duration-700 ease-in-out" style="width: <?= ($step - 1) * 33.33 ?>%"></div>
                    
                    <?php
                    $steps = ['Data', 'Kendaraan', 'Layanan', 'Bayar'];
